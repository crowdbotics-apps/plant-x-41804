"""
Django settings for plant_x_41804 project.
...
ROOT_URLCONF = 'plant_x_41804.urls'
...
WSGI_APPLICATION = 'plant_x_41804.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plant_x_41804 API",
    "DESCRIPTION": "API documentation for plant_x_41804 App",
    "VERSION": "v1",
}
